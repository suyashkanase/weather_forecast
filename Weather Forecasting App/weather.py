...
#weather
    api="https://api.openweathermap.org/data/2.5/onecall?lat="+str(location.latitude)+"&lon="+str(location.longitude)+"&units=metric&exclude=hourly&appid=adb6d85748dc3a4e3940233675aab192"
    ...
    #first cell
    firstdayimage= json_data['daily'][0]['weather']['icon']
    ...
    #second cell
    seconddayimage= json_data['daily'][1]['weather']['icon']
    ...
    day1temp.config(text=f"day:{tempday2}\n Night:{tempnight2}")

    #third cell
    thireddayimage= json_data['daily'][2]['weather']['icon']
    
    img=(Image.open(f"icon/{thireddayimage}@2x.png"))
    resized_image = img.resize((50,50))
    photo3 = ImageTk.PhotoImage(resized_image)
    thiredimage.config(image=photo3)
    thiredimage.image=photo3

    tempday3 = json_data['daily'][2]['temp']['day']
    tempnight3=json_data['daily'][2]['temp']['night']

    day1temp.config(text=f"day:{tempday3}\n Night:{tempnight3}")

    #fourth cell
    fourthdayimage= json_data['daily'][3]['weather']['icon']
    ...
    day1temp.config(text=f"day:{tempday4}\n Night:{tempnight4}")

    #fifth cell
    fifthdayimage= json_data['daily'][4]['weather']['icon']
    ...
    day1temp.config(text=f"day:{tempday5}\n Night:{tempnight5}")

    #sixth cell
    sixthdayimage= json_data['daily'][5]['weather']['icon']
    ...
    day1temp.config(text=f"day:{tempday6}\n Night:{tempnight6}")

    #seventh cell
    seventhdayimage= json_data['daily'][6]['weather']['icon']
    ...
    day1temp.config(text=f"day:{tempday7}\n Night:{tempnight7}")
...
# Timezone
timezone = Label(root, font=("Helvetica", 10), fg="white", bg="#57adff")
...
day2=Label(secondframe,font="arial 20",bg="#282829",fg="white")
day2.place(x=10,y=5)
...
thiredimage=Label(thirdframe,bg="#282829")
thiredimage.place(x=7,y=20)
